...
import { refreshChannelList, showScrapeProgress, showScrapeSuccess } from '../channelScraper';
import { getStorageData, onStorageChange, clearActiveFilters } from '../storage';
...
function injectCategorySection() {
  ...
  const waitForContainer = setInterval(() => {
    ...
    if (container) {
      ...
      if (videoGrid) {
        ...
        categoryRoot.render(<CategorySection />);
      }
    }
  }, 100);
